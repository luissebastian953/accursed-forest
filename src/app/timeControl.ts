...
/**
 * Ticks per real second. 1× is a day every five seconds (GDD 4.2), long enough to watch a
 * crew work a tree; 50× is ten days a second, a year in about half a minute.
 */
